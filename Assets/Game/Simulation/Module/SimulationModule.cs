...
namespace UnityEngine
{
    ...
    public class SimulationModule : GameModule
    {
        public override void Install(ServiceContainer container)
        {
            ...
            container.InstantiateAndBind<SimulatedLoadingOperation4>(new SimulatedLoadingOperation4.Settings("1241241241", 1));
            container.InstantiateAndBind<SimulatedLoadingOperation4>(new SimulatedLoadingOperation4.Settings("1424234", 1));
            container.InstantiateAndBind<SimulatedLoadingOperation4>(new SimulatedLoadingOperation4.Settings("2424", 1));
        }
    }
}